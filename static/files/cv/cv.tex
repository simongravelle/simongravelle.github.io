...
\begin{table}[htbp]
\begin{tabular}{@{} p{0.12\linewidth} p{0.84\linewidth} @{}}
\href{https://scholar.google.fr/citations?user=9fD2JlYAAAAJ&hl}{Scholar}  & My \hone{full publication list} is available from \href{https://scholar.google.fr/citations?user=9fD2JlYAAAAJ&hl}{Google Scholar}. \\
\end{tabular}
\end{table}
