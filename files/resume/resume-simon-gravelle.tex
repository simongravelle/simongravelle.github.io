...
{\textcolor{gray120}{\huge Current positions}}
\end{minipage}
...
& \hspace{0.2cm} $\bullet$ Starting Sep. 2025: Scientific Secretary of Section 08 of the National Committee, \\
...
& \textit{{\color{blue_1}NMR properties of water at interfaces}} \\
...
& \textit{{\color{blue_1}Graphene nanoparticle suspensions under shear}} \\
...
& \textit{{\color{blue_1}Fluidic transport in bio-inspired and synthetic nano-channels}} \\
...
\begin{tabular}{@{} p{0.13\linewidth} p{0.84\linewidth} @{}}
    \hline \hline
03/2025 & \hone{The first Tamtam meeting}, Aussois, France \\ % the 28th
